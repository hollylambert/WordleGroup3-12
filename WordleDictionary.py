...
SPANISH_FIVE_LETTER_WORDS = [
    "pista", "mundo", "danza", "silla", "llave", "largo", "luzca", "chico", "clave", "flaco",
    "fruta", "fuego", "brisa", "carro", "brazo", "zorro", "viejo", "verde", "veloz", "vasto",
    "valle", "vacío", "tumba", "trozo", "traje", "torre", "tonto", "tiene", "tened", "techo",
    "tarta", "surco", "suelo", "sucio", "subir", "solos", "sollo", "salsa", "salto", "salir",
    "ruido", "rueda", "rollo", "roble", "río", "reír", "redes", "ratos", "rampa", "radio",
    "quise", "quios", "puñal", "pulso", "prisa", "preza", "presa", "precio",  "pollo",
    "pluma", "playa", "plata", "plano", "pinta", "pinar", "pilar", "picos", "pétal", "pezca",
    "pecho", "patos", "pasta", "pasar", "parar",  "pañal", "pando", "palos", "paleta",
    "pájar", "osos", "oscur", "orbos", "orden", "opera",  "olor", "ojos", "ojalá",
    "nubes", "notas", "norma", "noble", "niece", "niebla", "nieve", "nexos", "nervi", "naran",
    "nariz", "nadie", "nacer", "muñec", "mutuo", "muy", "mucho", "morir",
     "mitad", "mismo", "miren", "minas", "miedo", "meses", "mesa", "merez", "mente",
    "melón", "mejor", "medio", "mayor", "matar", "masas", "marip", "manos", "mando", "manco",
    "mamá", "malos", "maleta", "mal", "maíz", "magia", "madre", "madar", "macho", "lugar",
    "llora", "lleno", "llama", "lindo", "limón", "limpio", "libro", "libre", "leyes", "león",
    "lento", "lejos", "leche", "lápiz", "lanza", "largo", "lados", "ladar", "labor", "joyas",
    "joven", "jotas", "jirafa", "jinet", "juego", "joven", "joyas"] 

FRENCH_FIVE_LETTER_WORDS = [ "piste", "chose", "monde", "hiver", "danse", "titre", "chien", 
"balle", "vague", "fruit", "moule", "crise", "tasse", "fleur", "conte", "route", "épice", 
"ombre", "toile", "brise", "plume", "lisse", "fiche", "thème", "sucre", "tache", "mèche", 
"trame", "verre", "fumer", "force", "joint", "poste", "loupe", "suite", "plage", "doute", 
"criée", "lueur", "salon", "sable", "poche", "ancre", "pelle", "queue", "livre", "pince", 
"douce", "débat", "butte", "maire", "pièce", "frein", "fesse", "ronde", "cesse", "cause", 
"perle", "sorte", "grise", "tueur", "radio", "hache", "moque", "laine", "phase", "boute", 
"gomme", "outil", "pause", "biche", "peine", "masque", "noire", "chute", "raton", "globe", 
"bride", "coute", "selle", "tente", "tissu", "noble", "prime", "boucl", "merve", "écrin", 
"timbr", "forge", "honte", "folie", "goûte", "scène", "malin", "bruit", "tourn", "brûle", 
"plein", "croix", "flots", "nuage", "virer", "paume", "class", "fonds", "ligne", "régir", 
"porte", "boite", "voile", "creux", "soupe", "vieux", "fraud", "brais", "fuite", "saint", 
"flair", "prier", "crête", "lourd", "torse", "givre", "vaste", "talon", "bravo", "clair", 
"blanc", "broie", "front", "flanc", "bains", "vigne", "voter", "trace", "tribu", "trier", 
"triad", "trend", "tremp", "tiers", "théor", "texte", "tests", "terme", "teint", "taule", 
"taise", "swing", "sueur", "stade", "spots", "sport", "spire", "spend", "souci", "sotie", 
"sorti", "sonde", "solex", "solde", "soeur", "snobs", "smash", "slips", "slang", "skier", 
"sites", "sirèn", "sirop", "singe", "since", "simpe", "siles", "série", "seuil", "seule", 
"septi", "sente", "senso", "selle", "seing", "secte", "seaux", "scout", "score", "scoop", 
"scène", "sceau", "savon", "sauce", "satis", "satin", "sages", "safre", "ruine", "royal", 
"rouge", "roues", "rotor", "roses", "rosée", "roots", "ronds", "rompu", "roman", "roche", 
"robot", "rives", "rivez", "rirez", "rires", "rient", "ridée", "rides", "ridez", "riche", 
"rhumé", "rêvez", "rêver", "rêves", "rêvée", "révis", "réuni", "répud", "répue", "réput", 
"réens", "réels", "rédui", "récup", "récap", "rébus", "réagi", "rôle", "quart", "pyrex", 
"purée", "publi", "pubis", "ptôse", "provo", "prote", "prose", "projo", "prise", "prion", 
"priée", "press", "prête", "prévu", "préau", "prêts", "prier", "prédé", "power", "pouss", 
"poule", "pouce", "posta", "posse", "porte", "porta", "porcs", "popes", "poney", "pondu", 
"poncé", "pompe", "polis", "poire", "poils", "point", "poème", "pluie", "plong", "pleur", 
"plein", "plats", "plate", "plant", "plais", "plain", "place", "pièce", "picks", "physi", 
"photo", "phono", "phase", "phare", "petit", "pétas", "pesto", "peste", "perso", "perçu", 
"perce", "pepsi", "peine", "peaux", "peauz", "pêche", "peace", "péage", "pavés", "pause", 
"patte", "paste", "passe", "pasma", "parks", "paris", "parée", "paréo", "parez", "parez", 
"papou", "papie", "palet", "pains", "pages", "packs", "ouïes", "otite", "osent", "osée", 
"omega", "olive", "oasis", "nuits", "noirs", "nobel", "nique", "ninja", "niez", "niche", 
"netto", "nègre", "naïfs", "nager", "mythe", "musée", "mulet", "morts", "moral", "moque", 
"moiti", "moine", "moche", "mocha", "mixes", "mites", "minée", "mille", "miels", "micro", 
"meurt", "messa", "merve", "merge", "mêler", "mélan"] 
